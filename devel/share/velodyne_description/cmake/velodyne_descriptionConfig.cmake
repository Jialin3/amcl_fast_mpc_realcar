...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tang/amcl_fast_mpc_realcar/src/omni_robot/velodyne_simulator/velodyne_description/${idir}'.  ${_report}")
    endif()

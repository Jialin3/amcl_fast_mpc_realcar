...
set(MSG_I_FLAGS "-Impc_tracking:/home/tang/amcl_fast_mpc_realcar/src/mpc_tracking/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tang/amcl_fast_mpc_realcar/src/mpc_tracking/msg/Bspline.msg" NAME_WE)
add_custom_target(_mpc_tracking_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mpc_tracking" "/home/tang/amcl_fast_mpc_realcar/src/mpc_tracking/msg/Bspline.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(mpc_tracking
  "/home/tang/amcl_fast_mpc_realcar/src/mpc_tracking/msg/Bspline.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpc_tracking)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpc_tracking\")")
  # install generated code
  install(
